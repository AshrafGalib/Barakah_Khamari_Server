...
const getRoleById = async (
  ...
  try {
    ...
    return res.status(200).json({
      success: true,
      message:
        "Role information loaded successfully",
      data: {
        role,
      },
    });
    ...
    try {
      ...
      return res
        ...
        .json({
          ...
          message:
            error.message ||
            "Role permissions load করা যায়নি",
        });
    }
  };
